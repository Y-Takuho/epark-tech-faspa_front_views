...
<div class="epark-header-app-banner">
  <a class="epark-header-app-banner__link" href="https://eparkapp.onelink.me/yuvN/3uvjh928" target="_blank">
    ...
    <img class="epark-header-app-banner__image" src="{{ asset('/v2/sfc/images/common/banner_app_dl/banner_detail_relaxation.png') }}?ver={{ config('const.cache_clear_ver') }}" alt="">
  </a>
</div>
